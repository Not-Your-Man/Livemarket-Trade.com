...
const tabContents = [
  (
    <div key="signup" className='py-10 font-Poppins text-white/80'>
      <div className=''>
        <h1 className='text-xl'><span className='text-[#0052FF]'>Create</span> a new account</h1>
        <p className="mr-10 font-normal text-gray-200 py-5"> Create a new<span className="text-[#0052FF] font-bold"> account</span> to enjoy immense benefits and financial freedom, it's easy, it's<span className=" text-[#0052FF] font-bold"> simple</span></p>
      </div>
      <form className='border-t-4 border-gray-500 border-opacity-5'>
         <div className='py-5 space-y-10'>
                <div>
                    ...
                    htmlFor="name">Legal Full Name</label>
                    <input 
  ...
  (
    <div key="login" className='py-10 font-Poppins text-white/80'>
      <div className=''>
        <h1 className='text-xl'><span className='text-[#0052FF]'>Sign-In</span> to your account</h1>
        <p className="mr-10 font-normal text-gray-200 py-5">Continue where you left off by logging in, we keep<span className=" text-[#0052FF] font-bold"> simple </span>of your every progress.
        </p>
      </div>
      <form className=''>
          <div className='py-5 space-y-10'>
                ...
                <div className="icon-cont flex justify-center items-center w-full default_cursor_cs default_cursor_land">
                    <div className="cont rounded-full p-5 bg-[#222] text-white/80 default_cursor_cs default_cursor_land">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9">
                            <path fillRule="evenodd" d="M8.25 6.75a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0zM15.75 9.75a3 3 
